      ...
      <main className={classes.home}>
        <div className={classes.homeContent}>
          ...
          <div className={classes.contentHome}>
            <h1>
              Bem Vindo Ao <span>Vincci PUB</span>
            </h1>
        ...
        <section className={classes.section}>
          <div className={classes.sectionTitle} data-aos="fade-up">
            ...
            <h2>Drinks com e sem álcoolasasaas</h2>
          </div>
          <div className={classes.container}>
            ...
            <div className={classes.cardItem} data-aos="fade-up" data-aos-delay="100">
              ...
              <p>
                Gin Tônica, Aperol Spritz e diversos outros drinks perfeitos para festas que demandam Elegância e
                Sofisticação.
              </p>
              <Link to="/Pacotes/">Ver Preços</Link>
            </div>
            <div className={classes.cardItem} data-aos="fade-up" data-aos-delay="100">
              ...
              <p>
                Grande variedade de Drinks e sabores não alcoólicos para agradar à todos os paladares e conquistar todos
                os seus convidados. Sem exceções.
              </p>
              <Link to="/Pacotes/">Ver Preços</Link>
            </div>
          </div>
